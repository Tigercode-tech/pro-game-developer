...
yellow_spaceship_img = pygame.image.load("images/spaceship_yellow.png")
red_spaceship_img = pygame.image.load("images/spaceship_red.png")
...
space = pygame.transform.scale(pygame.image.load("images/space_background.png"), (WIDTH, HEIGHT))
